...
![congress](https://www.google.com/url?sa=i&rct=j&q=&esrc=s&source=images&cd=&cad=rja&uact=8&ved=0ahUKEwjz6_nT7P_XAhXM5YMKHdEWDz4QjRwIBw&url=https%3A%2F%2Fen.wikipedia.org%2Fwiki%2FUnited_States_Congress&psig=AOvVaw2YL9YEukfaY6ujxclpBE9g&ust=1513009203635573)


### What is the Senate working on?

![](./plots/wordcloud.png){ width=103% }
```{r}
subject <- nodes %>%
...
Here are the subjects being discussed inside of over eight thousands bills by decsending frequency order. Ironically, "congressional oversight" is the most frequent subjects. 
